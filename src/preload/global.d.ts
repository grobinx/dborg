        ...
        dborg: {
            ...
            database: {
                ...
                connection: {
                    ...
                    metadata: {
                        getMetadata: (connectionId: string) => Promise<MetadataDetails>,
                        ...
                        findObjects: (connectionId: string, options: ObjectFindOptions) => Promise<MetadataAnyObjectHit[]>,
                        ...
                        getRoutineList: (connectionId: string, databaseId: string, schemaId: string | undefined, packageId: string | undefined, filter?: RoutineFilter) => Promise<RoutineDetails[]>,
                        getRoutine: (connectionId: string, databaseId: string, schemaId: string | undefined, packageId: string | undefined, id: string | IdentityOptions) => Promise<RoutineDetails | undefined>,
                        getSequenceList: (connectionId: string, databaseId: string, schemaId: string | undefined, filter?: SequenceFilter) => Promise<SequenceDetails[]>,
                        getSequence: (connectionId: string, databaseId: string, schemaId: string | undefined, id: string | IdentityOptions) => Promise<SequenceDetails | undefined>,
                        getTypeList: (connectionId: string, databaseId: string, schemaId: string | undefined, packageId: string | undefined, filter?: TypeFilter) => Promise<TypeDetails[]>,
                        getType: (connectionId: string, databaseId: string, schemaId: string | undefined, packageId: string | undefined, id: string | IdentityOptions) => Promise<TypeDetails | undefined>,
                        getPackageList: (connectionId: string, databaseId: string, schemaId: string | undefined, filter?: PackageFilter) => Promise<PackageDetails[]>,
                    ...
                    initializeMetadata: (uniqueId: string, progress?: (current: string) => void, forceReload?: boolean) => Promise<void>,
                },
                internal: {
