            ...
            database: {
                ...
                connection: {
                    ...
                    metadata: {
                        ...
                        getRoutineList: (connectionId: string, databaseId: string, schemaId: string | undefined, filter?: RoutineFilter) => Promise<RoutineDetails[]>,
                        getRoutine: (connectionId: string, databaseId: string, schemaId: string | undefined, id: string | IdentityOptions) => Promise<RoutineDetails | undefined>,
                        ...
                        getTypeList: (connectionId: string, databaseId: string, schemaId: string | undefined, filter?: TypeFilter) => Promise<TypeDetails[]>,
                        getType: (connectionId: string, databaseId: string, schemaId: string | undefined, id: string | IdentityOptions) => Promise<TypeDetails | undefined>,
