...
const icons = (palette: Palette): ThemeOptions => {
    return {
        icons: {
            ...
            DropCascade: (props) => <IconWrapper {...props} className="drop-cascade"><MuiIcons.DeleteSweepOutlined fontSize="inherit" color="error" /></IconWrapper>,
            DropRestrict: (props) => <IconWrapper {...props} className="drop-restrict"><MuiIcons.DeleteOutline fontSize="inherit" color="warning" /></IconWrapper>,
            ...
            CancelQuery: (props) => <IconWrapper {...props} className="cancle-query"><MuiIcons.CancelOutlined fontSize="inherit" /></IconWrapper>,
            ...
            AddRow: (props) => <IconWrapper {...props} className="add-row"><MuiIcons.AddBoxOutlined fontSize="inherit" color="success" /></IconWrapper>,
            RemoveRow: (props) => <IconWrapper {...props} className="remove-row"><MuiIcons.DeleteOutline fontSize="inherit" color="error" /></IconWrapper>,
            EditRow: (props) => <IconWrapper {...props} className="edit-row"><MuiIcons.EditOutlined fontSize="inherit" color="primary" /></IconWrapper>,
