...
export function ToUpperCaseAction(t: TFunction<"translation", undefined>): monaco.editor.IActionDescriptor {
    const actionId = "editor.actions.toUpperCaseExceptQuotes";

    return {
        id: actionId,
        label: t(actionId, "Convert to Upper Case (Except Quotes)"),
