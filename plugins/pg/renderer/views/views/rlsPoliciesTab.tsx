...
const rlsPoliciesTab = (
    ...
    return {
        id: cid("view-rls-policies-tab"),
        type: "tab",
        label: {
            id: cid("view-rls-policies-tab-label"),
            type: "tablabel",
            label: t("rls-policies", "RLS Policies"),
        },
        content: {
            id: cid("view-rls-policies-tab-content"),
            type: "tabcontent",
            content: () => ({
                id: cid("view-rls-policies-grid"),
                type: "grid",
                mode: "defined",
                rows: async () => {
...
order by policyname;
                ...
                autoSaveId: `view-rls-policies-grid-${session.profile.sch_id}`,
            } as IGridSlot),
        },
    };
};
