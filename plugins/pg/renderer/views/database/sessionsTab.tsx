                ...
                second: () => ({
                    ...
                    tabs: [
                        ...
                        ...(versionNumber >= 90600 ? [{
                            ...
                            type: "tab" as const,
                            label: {
                                id: cid("progress-vacuum-tab-label"),
                                type: "tablabel" as const,
                                label: t("progress-vacuum", "Progress VACUUM")
                            },
                            content: {
                            ...
                            toolBar: () => ({
                                id: cid("vacuum-tab-toolbar"),
                                type: "toolbar",
                                tools: [
                                    {
                                        onTick: async () => {
                                            slotContext.refresh(cid("progress-vacuum-grid"));
                                        },
                                        canPause: false,
                                        canRefresh: true,
